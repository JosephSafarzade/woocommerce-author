...
class wooa_elementor_widget_show_author_email extends \Elementor\Widget_Base
{
     ...
     * is_it_linkable (boolean)  whether to wrap the fetched data in <a> tag to make it clickable
     ...
     * we will call wooa_show_author_email shortcode with required parameters
     *
     *
     * @return void
     *
