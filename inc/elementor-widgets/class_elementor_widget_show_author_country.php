 ...
 *
 * @package wooa_elementor_widget_show_author_country
 * @extends \Elementor\Widget_Base
 * @version 1.0
 *
 */
class wooa_elementor_widget_show_author_country extends \Elementor\Widget_Base
{
    ...
    {
        return 'wooa_show_author_country';
    }
    ...
    {
        return esc_html__('Show Author Country', WOOA_TEXT_DOMAIN);
    }
    ...
    {
        return ['author', 'country', 'woocommerce'];
    }
     ...
     * we will call wooa_show_author_country_name shortcode with required parameters
     *
     *
     * @return void
     *
...
$widgets_manager->register(new \wooa_elementor_widget_show_author_country());
