...
/**
 * wooa_elementor_widget_show_author_description class.
 *
 * a class to register custom elementor widget which extends Widget_Base class of Elementor namespace
 *
 * @package wooa_elementor_widget_show_author_description
...
class wooa_elementor_widget_show_author_description extends \Elementor\Widget_Base
{
     ...
     * we will call wooa_show_author_description shortcode with required parameters
     *
     *
     * @return void
     *
