 ...
 *
 * @package wooa_elementor_widget_show_author_city
 * @extends \Elementor\Widget_Base
 * @version 1.0
 *
 */

class wooa_elementor_widget_show_author_city extends \Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Show Author City', WOOA_TEXT_DOMAIN);
    }
    ...
    {
        return ['author', 'city', 'woocommerce'];
    }
     ...
     * we will call wooa_show_author_city_name shortcode with required parameters
     *
     *
     * @return void
     *
...
$widgets_manager->register(new \wooa_elementor_widget_show_author_city());
