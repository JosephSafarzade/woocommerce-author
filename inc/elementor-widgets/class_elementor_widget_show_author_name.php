...
/**
 * wooa_elementor_widget_show_author_country class.
 *
 * a class to register custom elementor widget which extends Widget_Base class of Elementor namespace
 *
 * @package wooa_elementor_widget_show_author_name
 * @extends \Elementor\Widget_Base
 * @version 1.0
 *
 */
class wooa_elementor_widget_show_author_name extends \Elementor\Widget_Base
{
    ...
    public function get_title() {
        return esc_html__( 'Show Author Name', WOOA_TEXT_DOMAIN );
    }
     ...
     * we will call wooa_show_author_name shortcode with required parameters
     *
     *
     * @return void
     *
    ...
    protected function render() {
        ...
        $shortcode = sprintf(
            ...
            '[wooa_show_author_name author_id="%s" container_tag="%s"][/wooa_show_author_name]',
...
$widgets_manager->register( new \wooa_elementor_widget_show_author_name() );
